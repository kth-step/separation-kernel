...
static inline Cap cap_mk_memory(uint64_t begin, uint64_t end, uint64_t rwx,
                                uint64_t free, uint64_t pmp) {
        Cap c;
...
static inline Cap cap_mk_time(uint64_t hartid, uint64_t pid, uint64_t begin,
                              uint64_t end, uint64_t free, uint64_t depth) {
        Cap c;
