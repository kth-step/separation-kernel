...
#define S3K_SYSNR_READ_CAP 0
#define S3K_SYSNR_MOVE_CAP 1
#define S3K_SYSNR_DELETE_CAP 2
#define S3K_SYSNR_REVOKE_CAP 3
#define S3K_SYSNR_DERIVE_CAP 4
#define S3K_SYSNR_INVOKE_CAP 5
#define S3K_SYSNR_GET_PID 6
#define S3K_SYSNR_WRITE_REGISTER 7
#define S3K_SYSNR_READ_REGISTER 8
#define S3K_SYSNR_YIELD 9
