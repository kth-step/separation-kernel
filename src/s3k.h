    ...
    uint64_t arg3, uint64_t arg4, uint64_t arg5, uint64_t arg6, uint64_t arg7)
{
        ...
        case 7:
                asm volatile("ecall"
                             : "+r"(a0)
                             : "r"(a1), "r"(a2), "r"(a3), "r"(a4), "r"(a5), "r"(a6), "r"(t0));
                break;
        case 8:
                asm volatile("ecall"
                             : "+r"(a0)
                             : "r"(a1), "r"(a2), "r"(a3), "r"(a4), "r"(a5), "r"(a6), "r"(a7), "r"(t0));
                break;
        default:
...
#define S3K_SYSCALL8(a0, a1, a2, a3, a4, a5, a6, a7) S3K_SYSCALL(8, sysnr, a0, a1, a2, a3, a4, a5, a6, a7)
#define S3K_SYSCALL7(a0, a1, a2, a3, a4, a5, a6) S3K_SYSCALL(7, sysnr, a0, a1, a2, a3, a4, a5, a6, 0)
